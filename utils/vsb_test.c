...
void TestAlloAndFree()
{
	...
	if (VsbCountFree(vsb) != 120)
	{
		fprintf(stderr, "wrong countFree after free c\n");
	}
	
	if (VsbLargestFreeChunk(vsb) != 120)
	{
